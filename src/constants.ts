...
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  'CpynZY896DXN7hvFHjDBeWQ3i6YZe7Qjwg3RYChwTQWk',
)
...
// Creator fee (in %)
export const PLATFORM_CREATOR_FEE = 0.07 // 1% !!max 5%!!

// Jackpot fee (in %)
export const PLATFORM_JACKPOT_FEE = 0.0025 // 0.1%

// Referral fee (in %)
export const PLATFORM_REFERRAL_FEE = 0.003 // 0.3%
